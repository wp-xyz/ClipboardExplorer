...
const
  ...
  HTMLStr =
    ...
    '    h3{color:003366; font-family:Helvetica}' + LE +
    '    li{font-size:10pt; font-family:Arial,Helvetica; color:00}' + LE +
    '  </style>' + LE +
    '<body>' + LE +
    ...
    '    <li><a href="http://sourceforge.net/p/lazarus-ccr/svn/HEAD/tree/components/richmemo/">RichMemo</a></li>' + LE +
    '  </ul>' + LE +
...
begin
  ...
  IconImage.Picture.Icon.Current := 0;
  LblTitle.Caption := 'Clipboard Explorer ' + ResourceVersionInfo;
end;
